...
insert into articulos(nombre, descripcion, usuario_id, fecha, precio)
    values('Dragon Ball', 'Serie Completa', 3, current_timestamp+'2 seconds', 5),
          ('Dragon Ball Z', 'Serie Completa', 1, current_timestamp+'3 seconds', 50.3),
          ('Dragon Ball GT', 'Serie Completa', 2, current_timestamp+'4 seconds', 12.3),
          ('Dragon Ball Super', 'Serie Completa', 3, current_timestamp+'5 seconds', 1.3),
          ('sasuke', 'Imagen de sasuke con su mangeyko', 2, current_timestamp+'6 seconds', 5000),
          ('sharingan', 'imagen del sharingan', 1, current_timestamp+'7 seconds', 63);
